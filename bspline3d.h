...
public:
    Bspline3d();
    ~Bspline3d();
    void drawControlPoints(QOpenGLShaderProgram* m_program);
    void drawSurface(QOpenGLShaderProgram* m_program,float time ,float velocity=0.08f, float ampl=0.1f, float k=2*M_PI/0.6f);
