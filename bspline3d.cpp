...
void Bspline3d::drawControlPoints(QOpenGLShaderProgram* m_program)
{
...
void Bspline3d::drawSurface(QOpenGLShaderProgram* m_program,float time, float velocity, float ampl, float k)
{
